...
import PlayerSelectionPageTransitionController from './PlayerSelectionPageTransitionController';
...
export default {
	...
	created() {
		...
		this.voices = {
			...
			fallback: this.$tFormatted('voice.intro_revisit_player_check_fallback', voiceArgs),
		};
	},
	beforeDestroy() {
	...
	methods: {
		...
		handleAllComponentsReady() {
			this.transitionController = new PlayerSelectionPageTransitionController(this);
