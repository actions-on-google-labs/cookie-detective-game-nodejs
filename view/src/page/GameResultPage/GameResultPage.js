...
import GameResultPageTransitionController from './GameResultPageTransitionController';
import LottieAnimation from '../../component/asset/LottieAnimation/LottieAnimation';
import GameResultCard from '../../component/general/content/GameResultCard/GameResultCard';
import LevelUnlockedView from '../../component/general/content/LevelUnlockedView/LevelUnlockedView';
...
import SpriteSequence from '../../component/general/image/SpriteSequence/SpriteSequence';
...
export default {
	...
	computed: {
		...
		unlockedLevel() {
			...
			return this.$levelModel.getArrayOfItems().find(lev => lev.levelRequiredId === this.level.id);
		},
		isHighScore() {
			return this.gameResult.timestamp === this.getHighscoreResultPerLevel(this.level).timestamp;
		},
	},
	created() {
		...
		this.voices = {
			...
			level_unlocked_intro_fallback: this.$tFormatted('voice.level_unlocked_intro_fallback'),
			...
			try_again_fallback: this.$tFormatted('voice.game_lose_try_again_fallback'),
			what_to_do: this.$tFormatted('voice.game_end_what_to_do'),
			what_to_do_fallback: this.$tFormatted('voice.game_end_what_to_do_fallback'),
