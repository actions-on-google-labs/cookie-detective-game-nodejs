...
import ChooseHidingTypeTransitionController from './ChooseHidingTypeTransitionController';
...
export default {
	...
	methods: {
		...
		handleAllComponentsReady() {
			this.transitionController = new ChooseHidingTypeTransitionController(this);
