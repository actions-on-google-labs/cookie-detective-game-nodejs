...
import AnimalSelectionPageTransitionController from './AnimalSelectionPageTransitionController';
...
export default {
	...
	methods: {
		...
		handleAllComponentsReady() {
			this.transitionController = new AnimalSelectionPageTransitionController(this);
