...
import HidingModeSelectionPageTransitionController from './HidingModeSelectionPageTransitionController';
...
export default {
	...
	mixins: [gameSessionMixin, sceneDataMixin('hidingModeSelection'), preloaderMixin],
	data() {
		return {
			lottieAnimationId,
		};
	...
	methods: {
		...
		handleAllComponentsReady() {
			this.transitionController = new HidingModeSelectionPageTransitionController(this);
