...
import ColorSelectionPageTransitionController from './ColorSelectionPageTransitionController';
...
export default {
	...
	methods: {
		...
		handleAllComponentsReady() {
			this.transitionController = new ColorSelectionPageTransitionController(this);
